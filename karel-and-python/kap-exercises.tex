...
\begin{figure}[!ht]
\begin{center}
\includegraphics[height=0.4\textwidth]{imgk/a25.png}
\end{center}
\vspace{-4mm}
\caption{Move Karel by using {\tt go}, {\tt left}, {\tt right} command and use {\tt get} and {\tt put} to pick and place the gems.}
\label{fig:b09}
\vspace{-4mm}
\end{figure}
\noindent
...
\subsection{Exercise B010 - Find the gems hidden in the corner of the room}

{\em Write a program for Karel to relocate the gems by moving Left and Right 
to return home}

\vspace{-3mm}
\begin{figure}[!ht]
\begin{center}
\includegraphics[height=0.4\textwidth]{imgk/a26.png}
\end{center}
\vspace{-4mm}
\caption{Move Karel by using {\tt go}, {\tt left}, {\tt right} command and use {\tt get} and {\tt put} to pick and place the gems.}
\label{fig:b10}
...
\subsection{Exercise D04 - Hide and Seek}

{\em Karel's Friends(gems) are hiding somewhere in the builiding and Karel has to find them.
Write a program for Karel to inspect all shelves and make him find his friends and then return home.}

\vspace{-5mm}
\begin{figure}[!ht]
\begin{center}
\includegraphics[height=0.4\textwidth]{imgk/a33.png}
\end{center}
\vspace{-4mm}
\caption{Filling empty shelves with gems.}
\label{fig:a33}
...
\subsection{Exercise E04 - Karel facing obstacles}

{\em Karel has to go home but he has to follow a twisted path to reach home as there are a lot of obstacles on the way. Write a program for the robot to get there!}
\vspace{-5mm}
\begin{figure}[!ht]
\begin{center}
\includegraphics[height=0.4\textwidth]{imgk/a34.png}
\end{center}
\vspace{-4mm}
\caption{Karel only knows that his home is on the other side of the wall.}
\label{fig:a34}
...
\subsection{Exercise E05 - Karel as the Detective}

{\em Karel is a Detective and he has to find all the stolen gems. The theives have hidden them somwhere in the room. Write a program for Karel to find all the gems} 

\begin{figure}[!ht]
\begin{center}
\includegraphics[height=0.4\textwidth]{imgk/a35.png}
\end{center}
\vspace{-4mm}
\caption{Karel only knows that his home is on the other side of the wall.}
\label{fig:a35}
