...
comprises this solution manual
can be ordered at {\tt sales@femhub.com}. The textbook 
is also available as part of the NCLab course {\em Intro to Programming} 
that can be purchased at {\tt http://introtoprogramming.net}. \\[1mm]
Illegal copying and unauthorized use are prohibited.
}
\vfill
...
\vspace{4mm}
    ...
    {\tt http://introtoprogramming.net}.
    The course includes:\\[1cm]
\begin{itemize}
