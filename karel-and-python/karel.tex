...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=25mm]{imgk/Karel logo.JPG}
\end{center}
\vspace{-2mm}
\caption{Karel}
\label{fig:init}
...
\end{enumerate}
\newpage
\item The robot is facing the north. Which button will make him face the east ?
\begin{figure}[!ht]
\begin{center}
...
\end{figure}
\end{enumerate}
\item The robot is facing the south. Which two buttons out of these will you need make the robot move 1 step ahead and turn east ?
\begin{figure}[!ht]
\begin{center}
...
\end{enumerate}
\item The robot is facing the south.Which two buttons whill make him rotate 180 degrees ?
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=3cm]{imgk/button-left-4.png}\ \ \
\includegraphics[width=3cm]{imgk/button-go-2.png}\ \ \
