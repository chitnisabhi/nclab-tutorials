...
\item[A4] West
\end{enumerate}
\item Look at the button and decide where the robot is facing ?
\begin{figure}[!ht]
\begin{center}
...
\item[A4] West
\end{enumerate}
\item Decide in which direction is the robot facing if he turns to south after pressing this button ?
\begin{figure}[!ht]
\begin{center}
...
\begin{enumerate}
\item[A1] \begin{figure}[!ht]
\begin{center}
\includegraphics[width=3cm]{imgk/button-put-1.png}
\vspace{-10mm}
\end{center}
\end{figure}
\item[A2] \begin{figure}[!ht]
\begin{center}
\includegraphics[width=3cm]{imgk/button-go-1.png}
\vspace{-10mm}
\end{center}
\end{figure}
\item[A3] \begin{figure}[!ht]
\begin{center}
\includegraphics[width=3cm]{imgk/button-go-2.png}
\vspace{-10mm}
\end{center}
\end{figure}
\item[A4] \begin{figure}[!ht]
\begin{center}
\includegraphics[width=3cm]{imgk/button-right-2.png}
\vspace{-10mm}
\end{center}
\end{figure}
\item[A5] \begin{figure}[!ht]
\begin{center}
\includegraphics[width=3cm]{imgk/button-left-2.png}
\end{center}
\end{figure}
\end{enumerate}
\item The robot is facing South. Which two buttons out of these will you need to press 
to make the robot move one step ahead and turn East ?
\begin{figure}[!ht]
\begin{center}
...
\centerline{\Large If you liked the textbook, please consider:}
\vspace{2cm}

{\Large \bf Ordering Textbook and Solution Manual}
\vspace{4mm}

    {\Large Contact {\tt sales@femhub.com} to order full versions\\[2.5mm] of the textbook and solution 
    manual in PDF for \$99.95.}\\[2cm]

{\Large \bf Purchasing Online Course with Curriculum}
\vspace{4mm}

    {\Large NCLab's Course {\em Intro to Programming} can be purchased at 
    {\tt http://introtoprogramming.net}. The course includes:\\[1cm]
\begin{itemize}
...
\section{Intermission - Working with Code and Text Cells} \label{sec:editmenu}
