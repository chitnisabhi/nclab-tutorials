...
\begin{itemize}
\item Learn when one should use tuples.
\item Learn when one should use lists.
\item Learn when one should use dictionaries. 
\end{itemize}
...
loop that was already mentioned in Subsection \ref{subsec:forstr} 
and that will be discussed in more detail in Section \ref{sec:forloop}. \\
