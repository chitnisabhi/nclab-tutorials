...
the handling of multiple branches. If you think that "elif" sounds a lot like "else if" then 
you are absolutely right! Let us show an example:
...
Next let's put the {\tt while} loop to work. We have used this loop in Karel a lot,
