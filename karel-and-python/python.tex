...
\item Use the {\tt while} loop to make your first trip to scientific computing.
\end{itemize}
...
\begin{itemize}
\item Learn basic facts about the Scipy, Numpy, Pylab, Matplotlib, and Sympy libraries.
\end{itemize}
