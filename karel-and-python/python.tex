...
\begin{itemize}
\item Understand what exceptions are, when they can occur, and how to handle them.
...
\item[A2] Exceptional situation in the code leading to a crash. 
\item[A3] Division by zero.
...
\begin{itemize}
\item Understand that using libraries makes solving problems much simpler.
...
function aned concept described in this document. For example, it is possible to 
