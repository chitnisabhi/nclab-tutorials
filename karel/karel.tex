...
for you to learn Python, C++ and other programming languages. In particular we 
...
"Tutorials and Videos" on NCLab home page (same as the PDF file that you 
...
\end{itemize}
You will help him solve various tasks that he could not accomplish without your help, 
and on the way you will become a great programmer!
...
Despite its playful appearance, Karel is \underline{not a toy language}. It contains all elements 
...
learning language-specific details, because the most important thing in computer programming -- 
algorithmic thinking -- you will already have.
 
\section{Explore NCLab}

Before beginning this course, we invite you to create an account in 
NCLab, log in, and take a while to explore the great variety of activities 
