...
\begin{itemize}
\item Understand what variables are and that they can have different types.
\item Learn to work with numerical variables and print results.
\item Learn to write custom functions that return a value. 
\end{itemize}
...
my_name = "Melissa"
\end{verbatim}
Since then, each time someone calls a name, you retrieve in your brain the value of the variable
{\tt my\_name}, compare it to the name that you hear, and if you get a match then you turn around to see 
who is calling you. Imagine that we would not be able to use that variable!
...
school -- you just know it. The value is {\em stored}, it does not have to be {\em created}.
...
\begin{center}
\framebox{
Switch Karel to Level 3 
in Settings to use the new functionality presented in this section.}
\end{center}
\vspace{4mm}

\subsection{Getting GPS coordinates and printing}

Karel's coolest Christmas present is a new GPS device that allows him to determine his position 
...
\end{verbatim}
Try it! Also move Karel to other parts of the maze in Builder and run the program again
...
{\em Karel stands inside of a rectangle with unknown dimensions. Write a new function {\tt tape\_measure}  
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[height=0.4\textwidth]{img/var3.png}
\end{center}
\vspace{-4mm}
