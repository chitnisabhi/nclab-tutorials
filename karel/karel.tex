...
These commands have exactly the same function as pressing the buttons Left, Right, Go, 
Get, and Put in Manual mode.
...
\end{enumerate}
\item What is a {\em logical} mistake?
\begin{enumerate}
...
\end{enumerate}
\item What is a {\em syntactical} mistake?
\begin{enumerate}
