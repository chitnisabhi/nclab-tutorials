...
\end{enumerate}
\item Which of the following four programs is invalid?
\begin{enumerate}
\item[A1] {\tt a = gpsx}
\item[A2] {\tt a = gpsy}
\item[A3] {\tt a = zero}
...
{\em Write a procedure {\tt orchard} for the robot to count apples (gems) in his orchard. There are no walls
