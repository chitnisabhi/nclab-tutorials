...
NCLab provides a wide symbolic mathematics functionality via the Sympy library.
Sympy can be imported in any Python worksheet via 

\begin{verbatim}
from sympy import *
\end{verbatim}
In the following we will show a basic usage of Sympy. For its full usage,
visit Sympy home page {\tt http://sympy.org}.
