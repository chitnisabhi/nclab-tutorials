...
CUDA is an Nvidia language for massively parallel programming with Graphics Processing 
Units (GPUs). The CUDA worksheet provides programming via PyCUDA (Python wrappers to CUDA). 
Tutorial to PyCUDA is available via the link "Tutorials and Videos" 
...
\item What is SaaS?
\item What is WebGL?
\item What are GPU and CUDA?
\item Name the two most famous fractal sets.
\item What is Python? Of course we do not mean the snake!
