...
Solid Modeling, developed by Prof. Alberto Paoluzzi and his students at 
the University of Rome III in Italy. Alberto's help and support are 
...
\noindent
With PLaSM, the user can define a wide range of simple 3D objects, transform 
them, create intersections and unions via simple logical operations, and much 
more. This tutorial will guide the user in small steps and using many examples
through PLaSM's usage, and in the end, the user will be able to create advanced 
