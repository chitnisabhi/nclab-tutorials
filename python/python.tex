...
\begin{itemize}
\item Learn how to define new functions in Python.
\end{itemize}
{\em Functions}, sometimes also called {\em procedures} are (usually short) self-contained programs that perform a specific task. Many 
...
\begin{enumerate}
\item What do we mean by a {\em function} in Python? 
\begin{enumerate}
\item[A1] 
\item[A2] 
\item[A3] 
