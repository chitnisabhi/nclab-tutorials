...
This publication was created with the help of several freely 
available Sympy tutorials including http://docs.sympy.org, 
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\textwidth]{img/sympy-worksheet.png}
\end{center}
%\vspace{-2mm}
\caption{Sympy worksheets in NCLan.}
\label{fig:sympy-2}
\end{figure}
